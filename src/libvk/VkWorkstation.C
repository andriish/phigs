    ...
    VkComponent(name)
{
    ...
    installDestroyHandler();
     ...
     XtAddCallback(_baseWidget,
                   GLwNginitCallback,
                   &VkWorkstation::initCallback,
                   (XtPointer) this);

     XtAddCallback(_baseWidget,
                   GLwNexposeCallback,
                   &VkWorkstation::exposeCallback,
                   (XtPointer) this);
...
// RETURNS:     Class name
//
const char* VkWorkstation::className()
{
    return "VkWorkstation";
}
...
// RETURNS:     N/A
//
void VkWorkstation::initCallback(
    Widget w,
    XtPointer clientData,
    XtPointer callData
    )
{
    VkWorkstation *obj = (VkWorkstation *) clientData;
    obj->init();
}
...
// RETURNS:     N/A
//
void VkWorkstation::exposeCallback(
    Widget w,
    XtPointer clientData,
    XtPointer callData
    )
...
int main(int argc, char *argv[])
{
    ...
    VkWorkstation *ws = new VkWorkstation("ws", toplevel);
