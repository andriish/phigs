...
void phg_init_default_views(void)
{
     ...
     */
    view[1].map_matrix[0][0] = 0.5;
    view[1].map_matrix[3][0] = -0.5;
    view[1].map_matrix[1][1] = 0.5;
    view[1].map_matrix[3][1] = -0.5;
    ...
    view[5].map_matrix[3][0] = 0.5;
    view[5].map_matrix[3][1] = 0.5;
